...
const slides = [
  ...
  },
  {
    ...
    date: "01/01/2028",
        location:"Ancol",
    description: "Pan-Asian. Genre-fluid. Unapologetically loud. 88rising brings the wave — where hip-hop meets nostalgia and every track feels like a coming-of-age moment. Float up.",
  },
  {
    title: "Tulus",
    date: "03/03/2028",
        location:"ICE BSD",
    description: "Ada lagu yang hidup lebih lama dari perasaan yang melahirkannya. Malam ini, suara Tulus mengisi ruang yang selama ini kamu biarkan kosong. Datang dan bawa siapa saja yang kamu rindukan",
  },
];
          ...
          <div className="flex flex-col justify-between  w-full h-full  mb-5 lg:mb-0">
            <div>
              <h1 className="text-5xl md:text-6xl lg:w-130 text-center lg:text-left leading-14 md:leading-17  uppercase">
                {slides[carousellpage - 1].title}* <br/> @ {slides[carousellpage - 1].location}  
              </h1>
        ...
        {/* carousell Buttons */}
          <div className=" w-full flex justify-center lg:justify-start items-end lg:h-full">
            <div className="text-5xl w-fit gap-2 flex transition-all ease-initial">
                <button className={`${carousellpage === 1 ? "w-10" : "w-3"} h-3 ${carousellpage === 1 ? "bg-[#e6ff06]" : "bg-gray-400"} rounded-full transition-all ease-in`}
                onClick={()=>setCarousellpage(1)}></button>
                <button className={`${carousellpage === 2 ? "w-10" : "w-3"} h-3 ${carousellpage === 2 ? "bg-[#e6ff06]" : "bg-gray-400"} rounded-full transition-all ease-in`}
                onClick={()=>setCarousellpage(2)}></button>
                <button className={`${carousellpage === 3 ? "w-10" : "w-3"} h-3 ${carousellpage === 3 ? "bg-[#e6ff06]" : "bg-gray-400"} rounded-full transition-all ease-in`}
                onClick={()=>setCarousellpage(3)}></button>
            </div>
            </div>
        </div>
      </header>
